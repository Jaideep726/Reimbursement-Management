// src/pages/SignupPage.jsx — Task 02
// Admin signup. Country selection auto-fills company currency.
...
export default function SignupPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // RoleRouter in App.jsx redirects to /admin on success
    } catch (err) {
  ...
  return (
    <div className="min-h-screen flex"
      ...
      <div className="hidden lg:flex lg:w-5/12 flex-col justify-between p-14">
        <div>
          {/* Heading — all caps, bold, wide tracked display font */}
          <h1 style={{
          ...
          <p style={{ color: '#94a3b8', fontSize: '0.95rem', lineHeight: 1.7 }}>
            Multi-level approvals, receipt scanning, and real-time currency conversion — all in one place.
          </p>
        </div>
        ...
        <div className="w-full max-w-md bg-white rounded-2xl shadow-2xl p-8">
          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-4">
            ...
            <div>
              ...
              {/* Live rules — appear on first keystroke, turn green as each is met */}
            ...
            <div className="grid grid-cols-3 gap-3">
              <div className="col-span-2">
                <label className="block text-xs font-semibold text-gray-600 uppercase tracking-wide mb-1">Country</label>
